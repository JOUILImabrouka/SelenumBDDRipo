Feature: Home Page
         Tests for the 'http://the-internet.herokuapp.com/' home page
...
Background: Open home page
     ...
     And the page har a footer containing "Powered by Elemental Selenium"
     And the lik in the page footer goes to "http://elementalselenium.com/"
     And a "Fork me on GitHub" banner is display
